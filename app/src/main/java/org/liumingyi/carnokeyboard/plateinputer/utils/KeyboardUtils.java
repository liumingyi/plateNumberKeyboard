...
public class KeyboardUtils {
   ...
   * 隐藏软键盘
   */
  public static void hideSoftKeyboard(Context context, EditText item) {
   ...
   */
  public static boolean checkPointContains(PointF point, int left, int top, int right, int bottom) {
    float x = point.x;
    float y = point.y;
